...
if __name__ == '__main__':
    ...
    # Download and extract dataset
    if download_data == 'y':
        # weights_url = 'https://drive.google.com/uc?open&id=12oYbsfjyvYR_MosDfzhPjuEwZcF5LrF3&authuser=0'
        # weights_url = 'https://drive.google.com/uc?export=download&id=12oYbsfjyvYR_MosDfzhPjuEwZcF5LrF3'
        weights_url = 'https://dl.dropboxusercontent.com/s/vlz8ip8hh4nwmpa/gen_dis_default.zip?dl=0'
        #weights_url = 'https://drive.google.com/u/3/uc?id=12oYbsfjyvYR_MosDfzhPjuEwZcF5LrF3&export=download'
